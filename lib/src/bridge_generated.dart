...
class RustImpl implements Rust {
  ...
  Future<bool> isValidNumber(
    ...
    var arg1 = _platform.api2wire_String(region);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_is_valid_number(port_, arg0, arg1),
  ...
  Future<String> normalizePhoneNumber(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_normalize_phone_number(port_, arg0, arg1),
  ...
  Future<RegionInfo> getRegionInfo(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_get_region_info(port_, arg0, arg1),
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  void store_dart_post_cobject(ptr) {
